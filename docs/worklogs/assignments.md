...
| BC-041 | Protected Security Phase 1 — Minimum OPSEC Match and Redaction Contract | Codex | done | `docs/domains/runtime/assignments/BC-041/assignment.md` | `699ee1485cef39ffbe70c3b8e848763af02596e0` | Work `9ccd17d75955db4b64e5df27a5751d36b6964330`; metadata `9849c60138940068a0fd900eb49ce7444531109d`; original Claude review `ade01082a7bf4ebe389af6deafc68ea207d989d9` returned B-1 and remains immutable; closed through BC-041-C1 correction tip `204a229e2c01b255f1a940129cb724fa33fb4755`, current-main integration `131a527a8fef1f42df327443c9966c9e2f66f528`, final Claude correction review `f0998f78aaada899a16d4413170ef3689f04fe28` (`approve-with-notes`, zero blockers), and closure `1eb33e898b91c5e0de88985ca44530498b255c32`; no runtime implementation |
| BC-041-C1 | Unicode Format-Character OPSEC Correction | Codex | done | `docs/domains/runtime/assignments/BC-041-C1/assignment.md` | `33b44608cb634d1fedeed7f5f70d405c3999ed02` | First correction `80e5b8554639c274f7baa69155ea9b83910f604c`; first metadata `54519493189a332e984409504c45210e759f18fc`; first Claude review `874852c1b548ba4a2539d796d23ab9d803a966c8`; mixed correction `2a9d6a28111ca9576bf6811e67ccca37f4d5dd39`; mixed metadata `c6a447679c0ca07fb38a1e35eeb00231b0cb91e1`; second Claude review `f87588d0fa094c203fde3b847ab9bc3c28d1b3fe`; outer-edge correction `85e18f56f88ab113646cc3aab477687eda8b85af`; outer-edge metadata `d1c283ab21681f8a0550da32c2ec87e08eb2852d`; truth cleanup `204a229e2c01b255f1a940129cb724fa33fb4755`; final review `f0998f78aaada899a16d4413170ef3689f04fe28` (`approve-with-notes`, B-1'/B-1″ resolved, zero blockers); review import `3e77111b6d86879f591c7ab8c52a571c51e7c48e`; closure `1eb33e898b91c5e0de88985ca44530498b255c32`; implementation unauthorized |
| BC-050 | Python Runtime Phase 1 - Boot + Ordinary Turn + LM Studio Model Boundary | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `973589eea05fe42deeb829c5435bd09faf8cbe70` | First real Python runtime. Claude pre-flight review 1 `return-for-correction` (B-1/B-2/B-3); Amendment A closed all three; pre-flight review 2 `approve-with-notes`, zero blockers. Dad/Blu authorized implementation 2026-08-12 and moved implementation ownership from Codex to Claude for BC-050 only. Substantive implementation `708101d7f6dfc7748bb69d71f56e4da1044a2699`. Contradiction C-1 (the no-runtime-implementation rule encoded in three validators) resolved by BC-050-C1 under an explicit collision-domain amendment; OPSEC conformance oracle proven byte-identical. Suites pass: runtime 119, security 49, readiness 32, continuity 50. Known BC-020 fixed-base host-adapter finding persists and is unrelated. Editable-install verification outstanding. Live LM Studio smoke test `not_performed`. Ready for independent Codex implementation review. Not merged, not self-closed |
| BC-050-C1 | Authorized-Implementation Validator Alignment | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `708101d7f6dfc7748bb69d71f56e4da1044a2699` | Bounded correction resolving BC-050 C-1. Gated the stale pre-implementation guards in `tools/validate_opsec_contracts.py` and `tools/validate_continuity_contracts.py` on the same explicit BC-050 authorization evidence the readiness validator uses; unauthorized implementation still rejected in all three. OPSEC oracle byte-identical across twelve functions and six constants. Readiness `result_semantics` corrected to `python_phase1_implementation_authorized_and_active_pending_independent_review`. Internal test `sys.path` mutation removed. No production `src/blu_runtime/**` change. Reviewer: Codex. Not merged |
| BC-050-C2 | Independent Review Blocker Correction | Claude | active_correction | `docs/domains/runtime/assignments/BC-050/assignment.md` | `33be23a4c43a160e41e2aeca78962d1cbd3c4a47` | Responds to Codex independent review `33be23a` (`return-for-correction`, B-01 to B-07). Six blockers corrected: B-01 one byte-identical fail-closed authorization predicate in all three validators (22 mutations x 3 validators, 0 acceptances); B-03 positive chat-compatibility evidence; B-04 terminal completion established before candidate text; B-05 canonical CLEAR output; B-06 removed in-band `/exit` and `/quit` bypass; B-07 removed synthesized completion evidence. B-02 redone at rule granularity and **escalated** as authority contradictions C2-AC-01 (Verb Lock) and C2-AC-02 (Execution Law/Compliance Gate/Completion Proof residue); Dad/Blu decision required. Suites: runtime 154, security 50, readiness 35, continuity 58, all OK. Envelope digest, golden CTS, architecture 7/8/9, and the OPSEC oracle unchanged. Known BC-020 fixed-base finding preserved. Not merged, not self-closed |
| BC-050-C2A | Instruction-Layer Classification Cleanup / B-02 Resolution | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `b6333a761e9dbfe310fd1ce0e3203beabe3fefdf` | Dad/Blu authority decision resolving BC-050 B-02 and Claude contradictions C2-AC-01/C2-AC-02 by source reclassification, not claimed equivalence. `00_Instructions.md` remains immutable historical CTS deployment provenance but is not successor invariant canon, not a Python model-facing source, and not a parity source. CANON-001 moved to `legacy_deployment_artifacts`; CANON-006 no longer cites it; ChatGPT projection and parity matrix cleaned; 17 negative tests prevent reversion. No golden, envelope, or `src/blu_runtime/**` change. Suites: runtime 154, security 50, readiness 53, continuity 58. Known BC-020 finding preserved. Ready for independent Codex re-review. Not merged, not self-closed |
| BC-050-C3 | Final Independent Re-Review Micro-Correction | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `157441d3ea224760e8c800cdd19202cbb230d01d` | Corrects the last three blockers from Codex's second review. B-01 binds the authorization date to the exact approved value `2026-08-12` in all three validators, so cross-file equality is no longer mistaken for authentication (9 wrong dates x 3 validators, 0 acceptances). B-06 removes the false `/exit` startup guidance and names end-of-input instead. B-07 fails closed on malformed completion-evidence types instead of raising AttributeError. Only `src/blu_runtime/__main__.py` changed in production. Suites: runtime 162, security 50, readiness 53, continuity 58. Envelope, golden, architecture, and OPSEC oracle unchanged. Known BC-020 finding preserved. Ready for final independent Codex re-review. Not merged, not self-closed |
| BC-050-C4 | Live LM Studio Provider-Contract Correction | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `be19ea16b61088e78850d15662943357fb3ee9b0` | Bounded provider-adapter correction driven by the first real live LM Studio smoke, which failed boot with `PROVIDER_MODEL_ABSENT` while the endpoint was reachable and the model loaded. Native v1 identifies a model record with `key`, not `id`, and reports loaded capacity at `loaded_instances[].config.context_length`, not `loaded_instances[].context_length`; the record-level `max_context_length` is model capability and is never read as loaded-instance capacity. Only `src/blu_runtime/providers/model/lm_studio.py` changed in production; matching stays exact, all fail-closed capacity paths preserved, 13 live-shape regression tests added. Live smoke performed 2026-08-14 with the synthetic protected-policy fixture: boot now passes the provider boundary (observed context 1048576); the turn fails further down and was deliberately left uncorrected (envelope ~8021 tokens vs 4096 requested; chat response has no `status`, no top-level `id`, and instance id `granite-4.0-h-micro:2` vs inventory `granite-4.0-h-micro`). Suites: runtime 175, security 50, readiness 53, continuity 58. Envelope, golden, architecture 7/8/9, and OPSEC oracle unchanged. Known BC-020 finding preserved. Ready for independent Codex review. Not merged, not self-closed |
| BC-050-C5 | LM Studio Native-v1 Completion Proof Correction | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `ac784f0cb136593b73f65a128eee658918dbb023` | Bounded completion-proof correction under the Dad/Blu authority decision that Blu must model the provider's real contract. The live native-v1 stateless response carries no terminal `status`, no per-completion identifier, and a per-load instance ordinal the inventory does not report; the C3 boundary required all three, so a real completion was rejected as `PROVIDER_COMPLETION_UNVERIFIED` after the model had answered. Completion is now established from valid structure, consistent instance identity, supported typed output, usable content, and no provider/transport failure; an asserted terminal state still binds. Absence of a provider completion id is represented truthfully: `provider_completion_evidence_ref` is nullable and a new `provider_completion_proof` names `provider_assigned_completion_id` or `synchronous_provider_response`. No id is fabricated (no uuid, hash, coercion, request-id fallback, or `model_instance_id` relabelling) and `store` stays false. B-07 malformed-evidence rejection is unchanged and 24 malformed live-shaped bodies fail closed. Live smoke: full ordinary turn PASS against granite-4.0-h-micro with a truthful receipt. Suites: runtime 190, security 50, readiness 53, continuity 58. Envelope, golden, architecture 7/8/9, and OPSEC oracle unchanged. Known BC-020 finding preserved. Ready for independent Codex review. Not merged, not self-closed |
| BC-050-C5A | Completion Evidence Fail-Closed Micro-Correction | Claude | review | `docs/domains/runtime/assignments/BC-050/assignment.md` | `374cc29da43d104f7ed6e9628e3fd8ebe9c4ff25` | Micro-correction closing the two malformed-response holes from Blu's bounded C5 review. Blocker 1: `model_instance_id` no longer falls back to `model`; it must be present, a string, and non-blank after trimming, with nothing synthesized, coerced, or inferred, and the expected-model/loaded-instance agreement rule unchanged. Blocker 2: every asserted completion identifier (`id`, `response_id`, `completion_id`) is validated before one is selected, so a usable identifier can no longer conceal a malformed sibling; selection then follows the declared field order. Absence is still absence: with no identifier fields the stateless path keeps a null reference, the `synchronous_provider_response` proof, and `store:false`. Only `src/blu_runtime/providers/model/lm_studio.py` changed in production; 17 regression tests added. Live smoke re-run after the tightening: ordinary turn still PASS with a truthful receipt. Suites: runtime 207, security 50, readiness 53, continuity 58. Envelope, golden, architecture 7/8/9, and OPSEC oracle unchanged. Known BC-020 finding preserved. Ready for independent Codex review. Not merged, not self-closed |
