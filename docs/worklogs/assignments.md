...
| BC-041-C1 | Unicode Format-Character OPSEC Correction | Codex | review | `docs/domains/runtime/assignments/BC-041-C1/assignment.md` | `33b44608cb634d1fedeed7f5f70d405c3999ed02` | First correction `80e5b8554639c274f7baa69155ea9b83910f604c`; first metadata `54519493189a332e984409504c45210e759f18fc`; Claude review evidence `874852c1b548ba4a2539d796d23ab9d803a966c8` returned B-1' for correction; mixed-placement correction starts from `5451949` and is ready for a fresh independent review after substantive/metadata commit receipt; single Cf-removed candidate plus separator-tolerant matching supersedes the dual-static-view claim; technical readiness re-earned but implementation remains unauthorized |
