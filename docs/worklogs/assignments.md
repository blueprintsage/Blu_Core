...
| BC-017-C1 | Historical Archaeology Review Corrections | Codex | review | `docs/domains/runtime/assignments/BC-017-C1/assignment.md` | `c323cff06c9f111408f4a416817d78fc0f3e2d2b` | B-01/B-02/B-03 correction only; substantive correction commit `PENDING_METADATA_COMMIT`; independent re-review pending |
