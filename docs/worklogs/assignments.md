...
| BC-020 | Define Chat and Codex capability adapter contracts | Codex | review | `docs/domains/runtime/assignments/BC-020/assignment.md` | `d4157e79fc7e2df6e1bd53b589cabfa19cd7238f` | Work commit recorded by metadata-only follow-up; `adapters/`, adapter-domain documentation, validator/tests, and BC-020 records; specification only; branch `bc-020-chat-codex-adapter-contracts` |
