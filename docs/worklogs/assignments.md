...
| BC-040 | One-Blu Portability and Python Runtime Readiness | Codex | review | `docs/domains/runtime/assignments/BC-040/assignment.md` | `66e7ed52f5777bdef2e32c71a5e83b439b0d0ade` | Work `8516bd6845edaa3ef9b18077d91853ccc21e3c3b`; specification/readiness only; One-Blu canon, deployment targets, LM Studio Model Execution contract, package layout, Phase 1 slice, SUR-010 mapping, blocker reconciliation, BC-030 N1-N8, schema fixtures, and validators; result `not_ready_for_python_phase1` with SUR-001 as the only actual blocker; no runtime/provider implementation |
